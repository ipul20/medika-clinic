    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('body').on('click', '.nonAktif', function () {
                var id = $(this).data("id");
                Swal.fire({
                    title: "Yakin ingin Non Aktifkan Dokter?",
                    icon: "question",
                    showCancelButton: true,
                    ...
                    if (result.value) {
                        $.ajax({
                            type: "GET",
                            url: "{{ url($title) }}" + '/nonaktif/' + id,
                            success: function (data) {
                                loadpage('',5);
                                toastr.success("Successful update data!");
                            },
                            error: function (data) {
                                toastr.success("Failed update data!");
                            }
                        });
                    }
                });
            ...
            $('body').on('click', '.aktif', function () {
                var id = $(this).data("id");
                Swal.fire({
                    title: "Yakin ingin Aktifkan Dokter?",
                    icon: "question",
                    showCancelButton: true,
                    confirmButtonText: "Yes"
                }).then(function(result) {
