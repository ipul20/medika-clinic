...
<head>
    <meta charset="utf-8" />
    <title>{{ isset($title) ? 'Medika-Clinic | '.$title:'Medika-Clinic' }}</title>
...
<div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
    <!--begin::Logo-->
    <a href="#">
        <img alt="Logo" src="{{ asset('') }}theme/assets/media/logos/logo-light.png" />
    </a>
    <!--end::Logo-->
    <!--begin::Toolbar-->
    ...
    <div class="offcanvas-content pr-5 mr-n5">
        ...
        <div class="d-flex align-items-center mt-5">
            <div class="symbol symbol-100 mr-5">
                <div class="symbol-label" style="background-image:url({{asset('public/temps/assets/media/users/300_21
                        .jpg')}})"></div>
